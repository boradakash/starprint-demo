...
import {  RasterObj, CommandsArray } from '@ionic-native/star-prnt';
import { StarPRNT } from '@ionic-native/star-prnt/ngx';

@Injectable({ providedIn: 'root' })
export class ReceiptService {
 constructor(public starprnt: StarPRNT) {}
  ...
  getExampleReceipt(
    ...
    twoInchReceipt.push({ append: 'And tags attached\n' + '\n' });
    twoInchReceipt.push({
      appendAlignment: this.starprnt.AlignmentPosition.Center,
    });
    if (qrCodeExample) {
    ...
    threeInchReceipt.push({ append: 'And tags attached\n' + '\n' });
    threeInchReceipt.push({
      appendAlignment: this.starprnt.AlignmentPosition.Center,
    });
    if (qrCodeExample) {
    ...
    fourInchReceipt.push({ append: 'And tags attached\n' + '\n' });
    fourInchReceipt.push({
      appendAlignment: this.starprnt.AlignmentPosition.Center,
    });
    if (qrCodeExample) {
